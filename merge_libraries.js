...
// LOS 10 ORIGINALES ("TODO TERRENO")
...
// LOS 10 NUEVOS ("UNIVERSALES BASADOS EN IMÁGENES")
const newTemplates = [
...
// FUSIÓN
const allTemplates = [...originalTemplates, ...newTemplates];

const gava = pages.find(p => p.id === "103779998699180");
if (gava) {
  gava.templates = allTemplates;
  fs.writeFileSync(publicPath, JSON.stringify(pages, null, 2));
  console.log("¡Fusionados! Ahora tienes 20 plantillas en GavaLab. ✅");
}
